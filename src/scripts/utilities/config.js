...
config.taskCategories = [
    {
        title: 'Marketing',
        imageUrl: '../../images/cortana-microsoft.svg',
...
config.Pages =  [
            ...
            },
            {
                title: 'Marketing',
                content: [`Get more from your events, understand feedback and prospective`],
                imageUrl : '../../images/risk_monitoring.png',
                caseStudies: [
                    {
                        title: 'Marketing',
                        imageUrl: '../../images/cortana-microsoft.svg',
            ...
            },
            {
                title: 'Events',
                content: [`Get more from your events, understand feedback and prospective`],
                imageUrl : '../../images/content_synthesis.png',
                caseStudies: [{
                    title: 'Marketing',
                    imageUrl: '../../images/cortana-microsoft.svg',
                    content: 'Artificial Intelligence and Machine learning to help you acquire customers'
            ...
            },
            {
                title: 'Bots',
                content: [`Intelligent servants to serve customers 24*7`],
                imageUrl : '../../images/virtual_agents.png',
                    caseStudies: [{
                        title: 'Marketing',
                        imageUrl: '../../images/cortana-microsoft.svg',
                        content: 'Artificial Intelligence and Machine learning to help you acquire customers'
